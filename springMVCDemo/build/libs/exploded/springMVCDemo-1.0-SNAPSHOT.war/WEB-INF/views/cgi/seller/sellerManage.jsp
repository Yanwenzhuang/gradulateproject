          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="/cgi/seller/sellerManage">商家管理</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <%--<br>--%>
              <%--&lt;%&ndash;查询功能&ndash;%&gt;--%>
              <%--<form class="form-inline" role="form" method="/seller/manage">--%>
                  <%--注册时间--%>
                  ...
                  <table class="table table-hover" >
                      ...
                      <c:forEach items="${content}" var="s">
                          <tr>
                              ...
                              <td>${s.phone}</td>
                              <%--<td>--%>
                                  <%--<img src="/upload/${s.logo}" alt="" style="height: 25px;width: 30px">--%>
                              <%--</td>--%>
                              <td>${s.regdate}</td>
              ...
              <div align="center" class="page1">
                  ...
                  <a href="/cgi/seller/sellerManage?pageNow=1" >首页</a>
                  <c:choose>
                      <c:when test="${page.pageNow - 1 > 0}">
                          <a href="/cgi/seller/sellerManage?pageNow=${page.pageNow - 1}">上一页</a>
                      </c:when>
                      <c:when test="${page.pageNow - 1 <= 0}">
                          <a href="/cgi/seller/sellerManage?pageNow=1" >上一页</a>
                      </c:when>
                  </c:choose>
                  <c:choose>
                      <c:when test="${page.totalPageCount==0}">
                          <a href="/cgi/seller/sellerManage?pageNow=${page.pageNow}">下一页</a>
                      </c:when>
                      <c:when test="${page.pageNow + 1 < page.totalPageCount}">
                          <a href="/cgi/seller/sellerManage?pageNow=${page.pageNow + 1}">下一页</a>
                      </c:when>
                      <c:when test="${page.pageNow + 1 >= page.totalPageCount}">
                          <a href="/cgi/seller/sellerManage?pageNow=${page.totalPageCount}">下一页</a>
                      </c:when>
                  </c:choose>
                  <c:choose>
                      <c:when test="${page.totalPageCount==0}">
                          <a href="/cgi/seller/sellerManage?pageNow=${page.pageNow}" >   尾页</a>
                      </c:when>
                      <c:otherwise>
                          <a href="/cgi/seller/sellerManage?pageNow=${page.totalPageCount}">尾页 </a>
                      </c:otherwise>
                  </c:choose>
              </div>
