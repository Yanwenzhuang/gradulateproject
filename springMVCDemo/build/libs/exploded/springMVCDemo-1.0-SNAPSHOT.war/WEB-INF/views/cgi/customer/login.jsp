  ...
  <!--end header -->
	  ...
	  <div id="login-page">
	  	...
	  	<div class="container">
		      ...
		      <form class="form-login" action="${pageContext.request.contextPath }/cgi/customer/doCustomerLogin"
					method="post" enctype="multipart/form-data">
		        <h2 class="form-login-heading">顾客登录页面</h2>
		        <div class="login-wrap center-pill">
		            <input type="text" class="form-control" placeholder="账号" id="username" required
                           name="username" value="${customer.username}"  autofocus>
                    <br>

		            <input type="password" class="form-control" id="password"
                           placeholder="密码" required name="password" value="${customer.password}">

                    <label class="checkbox">
		                <span class="pull-right">
		                    还没有账号？<a data-toggle="modal" href="/cgi/customer/toCustomerRegisterUI">去注册</a>
