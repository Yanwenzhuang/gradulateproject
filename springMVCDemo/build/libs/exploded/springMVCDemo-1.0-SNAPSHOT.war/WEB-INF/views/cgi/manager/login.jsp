  ...
  <!--end header -->
	  ...
	  <div id="login-page">
	  	...
	  	<div class="container">
		      ...
		      <form class="form-login" action="${pageContext.request.contextPath }/cgi/manager/doLogin"
		        ...
		        <div class="login-wrap center-pill">
		            <input type="text" class="form-control" placeholder="账号" id="username" required
                           name="username" value="${manager.username}"  autofocus>
                    <br>

		            <input type="password" class="form-control" id="password"
                           placeholder="密码" required name="password" value="${manager.password}">
