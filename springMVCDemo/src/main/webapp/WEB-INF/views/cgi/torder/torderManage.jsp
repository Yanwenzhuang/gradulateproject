      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a class="active" href="/cgi/torder/manage">
                          <i class="fa fa-book"></i>
                          <span>订单管理</span>
                      </a>
                  </li>
      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div align="center" class="page1">
                  ...
                  <a href="/cgi/torder/manage?pageNow=1" >首页</a>
                  <c:choose>
                      <c:when test="${page.pageNow - 1 > 0}">
                          <a href="/cgi/torder/manage?pageNow=${page.pageNow - 1}">上一页</a>
                      </c:when>
                      <c:when test="${page.pageNow - 1 <= 0}">
                          <a href="/cgi/torder/manage?pageNow=1" >上一页</a>
                      </c:when>
                  </c:choose>
                  <c:choose>
                      <c:when test="${page.totalPageCount==0}">
                          <a href="/cgi/torder/manage?pageNow=${page.pageNow}">下一页</a>
                      </c:when>
                      <c:when test="${page.pageNow + 1 < page.totalPageCount}">
                          <a href="/cgi/torder/manage?pageNow=${page.pageNow + 1}">下一页</a>
                      </c:when>
                      <c:when test="${page.pageNow + 1 >= page.totalPageCount}">
                          <a href="/cgi/torder/manage?pageNow=${page.totalPageCount}">下一页</a>
                      </c:when>
                  </c:choose>
                  <c:choose>
                      <c:when test="${page.totalPageCount==0}">
                          <a href="/cgi/torder/manage?pageNow=${page.pageNow}" >   尾页</a>
                      </c:when>
                      <c:otherwise>
                          <a href="/cgi/torder/manage?pageNow=${page.totalPageCount}">尾页 </a>
                      </c:otherwise>
                  </c:choose>
              </div>
