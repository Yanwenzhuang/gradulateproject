...
<div class="danpin center">
  ...
  <div align="center" class="page">
    ...
    <a href="/cgi/goods/cusotmerInShop/${shopname}?pageNow=1" >首页</a>
    <c:choose>
      <c:when test="${page.pageNow - 1 > 0}">
        <a href="/cgi/goods/cusotmerInShop/${shopname}?pageNow=${page.pageNow - 1}">上一页</a>
      </c:when>
      <c:when test="${page.pageNow - 1 <= 0}">
        <a href="/cgi/goods/cusotmerInShop/${shopname}?pageNow=1" >上一页</a>
      </c:when>
    </c:choose>
    <c:choose>
      <c:when test="${page.totalPageCount==0}">
        <a href="/cgi/goods/cusotmerInShop/${shopname}?pageNow=${page.pageNow}">下一页</a>
      </c:when>
      <c:when test="${page.pageNow + 1 < page.totalPageCount}">
        <a href="/cgi/goods/cusotmerInShop/${shopname}?pageNow=${page.pageNow + 1}">下一页</a>
      </c:when>
      <c:when test="${page.pageNow + 1 >= page.totalPageCount}">
        <a href="/cgi/goods/cusotmerInShop/${shopname}?pageNow=${page.totalPageCount}">下一页</a>
      </c:when>
    </c:choose>
    <c:choose>
      <c:when test="${page.totalPageCount==0}">
        <a href="/cgi/goods/cusotmerInShop/${shopname}?pageNow=${page.pageNow}" >   尾页</a>
      </c:when>
      <c:otherwise>
        <a href="/cgi/goods/cusotmerInShop/${shopname}?pageNow=${page.totalPageCount}">尾页 </a>
      </c:otherwise>
    </c:choose>
  </div>
